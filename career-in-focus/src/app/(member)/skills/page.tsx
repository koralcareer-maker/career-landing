  ...
  return (
    <div dir="rtl" className="space-y-6">
      <ScreenExplainer
        ...
        description={[
          "המסך מציג את המיומנויות החסרות עבור תפקיד היעד שהוגדר, על בסיס דרכון הקריירה והפערים שזוהו על ידי ה-AI.",
          "כל מיומנות מסומנת ברמת עדיפות (גבוהה / בינונית / נמוכה), ומלוּוה במשאבי למידה מומלצים — קורסים, סרטונים ומאמרים.",
          "סימון \"השלמתי\" מעדכן את דרכון הקריירה ומשפיע אוטומטית על ציון ההתאמה שלך.",
        ]}
      />
