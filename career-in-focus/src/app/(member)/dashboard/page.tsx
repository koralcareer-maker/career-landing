  ...
  return (
    <div className="min-h-screen relative">
      ...
      <ScreenExplainer
        title="לוח הבקרה"
        description={[
          "מרכז הניהול האישי לחיפוש העבודה: ציון ההתאמה למשרות, תוכנית הפעולה היומית, סטטוס המועמדויות הפעילות, אירועים בקהילה ועדכונים שוטפים.",
          "כל מודול במערכת — לוח המשרות, דרכון הקריירה, מאמנת ה-AI, מעקב המועמדויות — נגיש מכאן בלחיצה.",
        ]}
