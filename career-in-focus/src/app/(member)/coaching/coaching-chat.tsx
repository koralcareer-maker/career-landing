...
const QUICK_ACTIONS: Array<{
  ...
  },
  {
    ...
    tone: "purple",
    prompt: "תסרקי את לוח המשרות במערכת ותציגי לי את המשרות עם תווית 🔒 'מתחת לרדאר' שהכי מתאימות לפרופיל שלי. לכל משרה תציגי: (1) שם חברה + טייטל התפקיד + הקישור המלא להגשה מהמערכת, (2) למה היא מתאימה לי ספציפית בהתבסס על הניסיון שלי, (3) דרך פנייה מומלצת לאותה חברה (LinkedIn DM, מייל ישיר, נטוורקינג). אסור להמציא חברות שלא ברשימה במערכת.",
  },
  {
    icon: Building2,
