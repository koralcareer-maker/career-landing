  ...
  return (
    <div className="max-w-3xl space-y-5">
      <ScreenExplainer
        title="מאמנת AI"
        description={[
          "שיחה אישית עם מאמנת AI שיש לה גישה מלאה לפרופיל שלך: חוזקות, פערים, מועמדויות, ציון ההתאמה והקורות חיים שהועלו.",
          "ניתן לשאול כל שאלה בתחום חיפוש העבודה — אופן פנייה למגייסים, ניסוח מכתבי מקדים, הכנה לראיונות, מיפוי חברות יעד, ועוד.",
          "כל ההמלצות מבוססות על הנתונים האישיים שלך, ולא על תוכן גנרי מהאינטרנט.",
        ]}
      />
      {/* Header */}
