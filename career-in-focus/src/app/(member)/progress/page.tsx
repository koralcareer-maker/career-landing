    ...
    <div className="p-4 sm:p-6">
      <ScreenExplainer
        ...
        description={[
          ...
          "כל מועמדות חדשה שמגיעה מלוח המשרות נכנסת כאן אוטומטית. ניתן להוסיף ידנית מועמדויות שהוגשו מחוץ למערכת דרך הכפתור 'הוספת משרה'.",
          "מאמן ה-AI משתמש בנתונים מהמסך הזה כדי לתת המלצות מבוססות נתונים.",
        ]}
      />
      <TrackerClient
