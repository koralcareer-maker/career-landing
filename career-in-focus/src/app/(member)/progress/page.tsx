  ...
  return (
    <div className="p-4 sm:p-6">
      <ScreenExplainer
        ...
        description={[
          "מרכז התפעול של חיפוש העבודה: ציון ההתקדמות, תוכנית פעולה יומית, מועמדויות פעילות, ראיונות קרובים ותזכורות אוטומטיות לפולואפים.",
          "כל מועמדות שמוגשת מתוך לוח המשרות מתועדת כאן אוטומטית. ניתן להוסיף גם מועמדויות חיצוניות באמצעות כפתור \"הוספת משרה\".",
          "המאמנת AI מסתמכת על הנתונים בעמוד זה לצורך מתן המלצות מותאמות.",
        ]}
      />
      <TrackerClient
