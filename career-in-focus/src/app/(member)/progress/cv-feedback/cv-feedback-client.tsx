    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 leading-relaxed max-w-2xl">
          {t(
            "העלי את קורות החיים, ובתוך ~20 שניות תקבלי משוב כמו ממגייסת מקצועית — ציון איכות, סיכון ATS, ומה לתקן עכשיו כדי להשיג יותר ראיונות.",
            "העלה את קורות החיים, ובתוך ~20 שניות תקבל משוב כמו ממגייסת מקצועית — ציון איכות, סיכון ATS, ומה לתקן עכשיו כדי להשיג יותר ראיונות.",
          )}
        </p>
      </div>
