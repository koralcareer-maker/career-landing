...
const STEPS = [
  {
    ...
    // Titles and tips below use noun/infinitive form so they work for
    // any gender — "מילוי הפרופיל" instead of "מלא את הפרופיל" /
    // "מלאי את הפרופיל". Cleaner than threading a gender helper into
    // a 7-item static array.
    title: "מילוי הפרופיל",
    desc: "הוספת תפקיד נוכחי, תפקיד מבוקש, קישור לינקדאין וקורות חיים. זה הבסיס שממנו ה-AI מתחיל לעבוד.",
    href: "/profile",
    cta: "לפרופיל",
    time: "5 דקות",
  },
  {
    ...
    title: "יצירת דרכון הקריירה",
    desc: 'מענה על 15 שאלות קצרות — ה-AI מנתח ומייצר דרכון קריירה אישי עם חוזקות, פערים, תפקידים מתאימים ותוכנית פעולה.',
    href: "/skills",
    cta: "ליצירת דרכון",
    time: "10 דקות",
  },
  {
    ...
    title: "משרות שנבחרו במיוחד",
    desc: "משרות נבחרות ידנית — עם כפתור מעקב ישיר לטראקר. סימון 'שמור' מאפשר לעקוב אחרי הגשות.",
    href: "/jobs",
    cta: "ללוח המשרות",
    time: "מתחדש שבועית",
  },
...
const TIPS = [
  "כדאי לעדכן את הטראקר אחרי כל שליחה — זה עוזר לראות תמונה אמיתית",
  "שלוש בקשות ביום לפחות — כמות + איכות = תוצאות",
  "כדאי לקרוא לפחות עדכון אחד בשבוע — הם מכילים תוכן ערכי ועדכוני שוק",
  "תבניות הנטוורקינג מאוד עוזרות — פנייה ישירה לאנשי קשר עובדת היטב",
  "כדאי לבדוק את דף המגייסים — יש שם פרטי קשר ישירים לעשרות חברות",
];
