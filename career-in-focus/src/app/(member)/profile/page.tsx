  ...
  return (
    <div className="space-y-6">
      <ScreenExplainer
        ...
        description={[
          "דרכון הקריירה האישי מציג ניתוח מעמיק של הפרופיל: ציון ההתאמה לשוק העבודה, חוזקות מובילות, פערים מקצועיים שזוהו, תפקידים מומלצים, וצעדי פעולה ממוקדים.",
          "עדכון הפרופיל דרך הכפתור \"עריכת הפרופיל\" מפעיל ניתוח מחדש של הדרכון, כולל המלצות מעודכנות.",
        ]}
      />
