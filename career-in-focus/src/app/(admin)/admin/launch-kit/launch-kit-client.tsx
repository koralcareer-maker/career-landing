...
✓ דרכון קריירה AI שמגלה את החוזקות שלך
...
Description: דרכון קריירה AI · אלפי משרות · קהילה מקצועית. ביטול בכל עת.`,
      },
      {
        label: "מודעה B",
...
🎯 דרכון קריירה AI — ניתוח חוזקות, פערים ותפקידי יעד
...
אני בונה כלי שאני חושבת שיכול להעצים את הלקוחות שלך — דרכון קריירה AI שמספק ניתוח חוזקות וכיוונים תוך 5 דקות. רוב הזמן זה לוקח 2-3 פגישות.
...
דרכון קריירה AI שמנתח את החוזקות שלך ב-5 דקות, ולוח משרות עם ציון התאמה אישי לכל משרה.
השבוע השקה — חודש ראשון ב-19 ש"ח.
app.careerinfocus.co.il`,
      },
      {
        label: "לקבוצות \"אמהות חוזרות לעבודה\"",
        text: `חזרה לעבודה אחרי לידה זה אתגר. בניתי מערכת שעוזרת לזהות מה משלים אצלך גם אחרי הפסקה — דרכון קריירה AI + ליווי אישי.
19 ש"ח חודש ראשון.
app.careerinfocus.co.il`,
      },
      {
