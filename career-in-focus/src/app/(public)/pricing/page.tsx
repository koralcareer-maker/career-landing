...
const FAQ = [
  ...
  { q: "מה ההבדל בין פרו לחבר רגיל?", a: "פרו כולל ליווי אישי מקורל — ביקורת CV, פגישות ייעוץ ומענה אישי. חבר רגיל מקבל גישה לכל הכלים ללא ליווי אישי." },
  { q: "מה זה VIP?", a: "השירות הגבוה ביותר — קורל בעצמה שולחת פניות בשמך למגייסים ולאנשי קשר בחברות יעד, ובונה איתך אסטרטגיית חיפוש אגרסיבית ומובנית." },
];
