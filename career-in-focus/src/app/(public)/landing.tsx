...
const FEATURES = [
  ...
  { icon: Star,         title: "דרכון קריירה",     desc: "ניתוח מעמיק של חוזקות, פערי מיומנויות ותפקידים מומלצים — מותאם אישית" },
  ...
  { icon: Users,        title: "גישה למגייסים ולמשרות סמויות",         desc: "מאגר מגייסים מאומתים + משרות מתחת לרדאר שלא מתפרסמות בלוחות הדרושים" },
];
