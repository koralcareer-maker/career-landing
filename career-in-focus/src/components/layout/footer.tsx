...
import {
  Facebook, Linkedin, Instagram, Mail, Music2,
  MessageCircle, Phone,
...
export async function Footer() {
  ...
  const socials = [
    ...
    { href: "https://www.instagram.com/koral_shalev/",                          label: "אינסטגרם",         icon: Instagram,     brand: "from-[#F58529] via-[#DD2A7B] to-[#8134AF]" },
    { href: "https://www.tiktok.com/@koralshalev",                              label: "טיקטוק",            icon: Music2,        brand: "from-[#FF0050] via-[#000000] to-[#00F2EA]" },
    { href: "https://www.linkedin.com/in/koral-shalev-29430816a/",              label: "לינקדאין",          icon: Linkedin,      brand: "from-[#0A66C2] to-[#004182]" },
    { href: "https://www.facebook.com/profile.php?id=100076055198052",          label: "פייסבוק",           icon: Facebook,      brand: "from-[#1877F2] to-[#0E5BC2]" },
